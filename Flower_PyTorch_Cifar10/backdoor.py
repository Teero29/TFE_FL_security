...
class PoisonedCifarClient(fl.client.NumPyClient):
    ...
    def __init__(
        ...
        num_examples: Dict,
        backdoor_trigger_label: int = 7,  # Set the label to trigger the backdoor
    ) -> None:
        self.model = model
    ...
    def reset_backdoor(self) -> None:
        ...
        self.backdoor_trigger_label = 7  # Set it back to the original trigger label
...
def main() -> None:
    ...
    client = PoisonedCifarClient(model, trainloader, testloader, num_examples)
